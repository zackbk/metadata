...
golem::fill_desc(
  ...
  author_last_name = "Kedida", # Your Last Name
  author_email = "zackbk@gmail.com", # Your Email
...
usethis::use_ccby_license("Zekarias Kedida")  # You can set another license here
